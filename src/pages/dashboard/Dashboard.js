            ...
            <Row className="gutter">
              ...
              <Col xs={6} sm={6} xl={3}>
                <Widget className="widget-p-sm">
                  <div className={s.smallWidget}>
                    <div className="d-flex mb-4">
                    <div className="py-1 mr-2 img-fluid"> <Icons.EmojiTransportation /></div>
                      <div className="d-flex flex-column">
                        <p className="headline-3">Franchise</p>
                        <p className="body-2"><span className="body-3 muted">13</span></p>
                      </div>
                    </div>
                    <div>
